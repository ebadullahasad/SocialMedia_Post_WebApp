      ...
      <div className="w-full lg:w-full transition-all duration-500 h-full">
        ...
        <header className="w-full p-4 flex justify-between items-center z-50">
          ...
          >
            ...
            {search && (
              <div className="flex md:w-auto w-[70%] items-center justify-center gap-2 cursor-pointer lg:p-0 ">
                <div
            ...
            >
              <img
                src={IMAGES.AVATAR}
                alt="Avatar"
                className="lg:w-8 md:w-8 w-6 object-contain xl:block dark:block hidden"
              />
              <img
                src={IMAGES.AVATAR2}
                alt="Avatar"
                className="lg:w-8 md:w-8 w-6 object-contain  block xl:hidden dark:hidden"
              />
              <span className="text12 xl:text-whiteColor dark:text-white text-blueColor md:block hidden">
                User Workplace
              </span>
            ...
            >
              ...
              <p className="cursor-pointer" onClick={() => navigation("/")}>
                Logout
              </p>
            </div>
            {/* Drop Down  */}
