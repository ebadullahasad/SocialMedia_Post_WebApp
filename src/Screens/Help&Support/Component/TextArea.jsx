...
const TextArea = () => {
  ...
  return (
    <div className="lg:w-[50%] w-full relative md:my-8 my-5">
      <div className="relative  md:h-[200px] h-[170px]  custom-scroll border border-gray rounded-lg shadow-custom px-4 py-6 bg-white  ">
        <textarea
